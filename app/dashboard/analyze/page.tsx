...
export default function AnalyzePage() {
  ...
  useEffect(() => {
    ...
    if (company && state.availableCompanyTypes.length > 0 && !state.selectedCompanyType) {
      const primaryType = state.availableCompanyTypes.find(ct => ct.id === company.primary_company_type_id)
      if (primaryType) {
